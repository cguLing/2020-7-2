   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			location.href = "EDShow";
		} else {
			location.href = "cms/empdepart/AddED.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <table width="500" height="200" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
            <td>职位:</td>
            <td><input  type="post" name="post"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="50">
            <td colspan="2">
