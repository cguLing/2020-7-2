   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			location.href = "EmpShow";
		} else {
			location.href = "cms/employee/ModifyEmp.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <table width="500" height="400" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
            <td>需要修改的员工编号:</td>
            <td><input  type="empID" name="empID"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的部门编号:</td>
            <td><input  type="departID" name="departID"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的员工姓名:</td>
            <td><input  type="name" name="name"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的员工性别:</td>
            <td><input  type="sex" name="sex"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的员工身份证号:</td>
            <td><input  type="cardID" name="cardID"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的员工电话:</td>
            <td><input  type="phone" name="phone"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的员工邮箱:</td>
            <td><input  type="email" name="email"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr>
            <td>确定修改后的员工家庭地址:</td>
            <td><input  type="Faddress" name="Faddress"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的员工薪水（年）:</td>
            <td><input  type="salary" name="salary"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="50">
            <td colspan="2">
