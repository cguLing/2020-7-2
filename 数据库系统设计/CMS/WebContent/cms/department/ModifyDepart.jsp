   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			...
			location.href = "cms/department/ModifyDepart.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <form action="DepartUpdate" method="post">
    <table width="500" height="300" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
            <td>确定修改后的部门负责人:</td>
            <td><input  type="depEr" name="deper"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr>
            <td>确定修改后的部门描述:</td>
            <td><input  type="depDsc" name="depdsc"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr>
            <td colspan="2">
