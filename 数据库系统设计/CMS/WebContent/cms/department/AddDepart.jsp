   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			location.href = "DepartShow";
		} else {
			location.href = "cms/department/AddDepart.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <form action="DepartAdd" method="post">
    <table width="500" height="300" border="1" cellpadding="0" cellspacing="0">
        <tr height="50">
            <th colspan="2" ><h3>添加部门</h3></th>
        </tr>
        <tr height="30">
            <td>部门编号:</td>
            <td><input width="400" type="depID" name="depid"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>部门负责人:</td>
            <td><input width="400" type="depEr" name="deper"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr>
            <td>部门描述:</td>
            <td><input width="400" type="depDsc" name="depdsc"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr>
