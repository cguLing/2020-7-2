   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			location.href = "ProjShow";
		} else {
			location.href = "cms/project/ModifyProj.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <form action="ProjUpdate" method="post">
    <table width="500" height="400" border="1" cellpadding="0" cellspacing="0">
        <tr height="50">
            <td colspan="2"><h3>修改项目信息</h3></td>
        </tr>
        <tr height="30">
            <td>需要修改的项目编号:</td>
            <td><input  type="projID" name="projid"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的负责部门编号:</td>
            <td><input  type="depID" name="depid"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的项目负责人:</td>
            <td><input  type="projEr" name="projer"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的客户编号:</td>
            <td><input  type="custID" name="custid"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的项目名称:</td>
            <td><input  type="projName" name="projname"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr>
            <td>确定修改后的内容简述:</td>
            <td><input  type="projText" name="projtext"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的创建时间:</td>
            <td><input  type="projStart" name="projstart"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的状态码:</td>
            <td><input  type="projSta" name="projsta"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的结束时间:</td>
            <td><input  type="projEnd" name="projend"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="50">
            <td colspan="2">
