   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			location.href = "CustShow";
		} else {
			location.href = "cms/customer/ModifyCust.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <table width="500" height="300" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
            <td>确定修改后的客户姓名:</td>
            <td><input  type="custName" name="custname"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的客户性别:</td>
            <td><input  type="custSex" name="custsex"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的客户电话:</td>
            <td><input  type="custTel" name="custtel"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的客户邮箱:</td>
            <td><input  type="custEmail" name="custemail"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>确定修改后的客户身份证号:</td>
            <td><input  type="custSfz" name="custsfz"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="50">
            <td colspan="2">
