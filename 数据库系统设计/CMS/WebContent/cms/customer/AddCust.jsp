   ...
   application.setAttribute("isAdmin", "1");
	...
	if(info!=null&&!"".equals(info)){%>
		...
		if (confirm("操作成功！是否进行查看？")) {
			...
			location.href = "cms/customer/AddCust.jsp";
		}
		</script>
	<%}
	else {%> 
    ...
    <table width="500" height="270" border="1" cellpadding="0" cellspacing="0">
        <tr height="50">
            <td colspan="2"><h1>添加客户</h1></td>
        </tr>
        <tr height="30">
            <td>姓名:</td>
        ...
        <tr height="30">
            <td>邮箱:</td>
            <td><input  type="email" name="custemail"  style="background-color:transparent;border:0;"/></td>
        </tr>
        <tr height="30">
            <td>身份证:</td>
